...
for processes in [2, 4, 6]:
    ...
    command = f"mpirun --oversubscribe -np {processes} ./mpi/matrix {input_file} {power} 1 2"
...
for threads in [2, 4, 8]:
    for processes in [2, 4, 8]:
        ...
        command = f"mpirun --oversubscribe -np {processes} ./Pthreads_MPI/mpi_pthreads {input_file} {power} 1 2 {threads}"
